...
```{r}
mod1_df = data.frame(summary(mod1)$coefficients[,], confint(mod1))
...
```{r}
mod2_df = data.frame(summary(mod2)$coefficients[,], confint(mod2))
...
```{r}
mod3_df = data.frame(summary(mod3)$coefficients[,], confint(mod3))
...
```{r}
mod4_df = data.frame(summary(mod4)$coefficients[,], confint(mod4))
...
```{r}
mod5_df = data.frame(summary(mod5)$coefficients[,], confint(mod5))
...
```{r}
mod6_df = data.frame(summary(mod6)$coefficients[,], confint(mod6))
...
```{r}
write.csv(model_sum5, '../outputs/model_summary/2020-05-27_spatial-res-gcc-ndvi.csv', row.names = F)
