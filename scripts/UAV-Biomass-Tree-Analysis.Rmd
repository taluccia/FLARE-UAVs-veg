...
```{r}
data.frame(summary(lsmeans(mod1, ~ tree_biomass_C_g_m), type = "response"))
```
...
```{r}
data.frame(summary(lsmeans(mod2, ~ tree_biomass_C_g_m), type = "response"))
```
...
```{r}
data.frame(summary(lsmeans(mod3, ~ tree_biomass_C_g_m), type = "response"))
```
...
```{r}
data.frame(summary(lsmeans(mod4, ~ tree_biomass_C_g_m), type = "response"))
```
...
```{r}
data.frame(summary(lsmeans(mod5, ~ tree_biomass_C_g_m), type = "response"))
```
...
```{r}
data.frame(summary(lsmeans(mod6, ~ tree_biomass_C_g_m), type = "response"))
```
...
```{r}
data.frame(summary(lsmeans(mod7, ~ tree_biomass_C_g_m), type = "response"))
```
...
```{r}
data.frame(summary(lsmeans(mod8, ~ tree_biomass_C_g_m), type = "response"))
```
...
```{r}
data.frame(summary(lsmeans(mod9, ~ tree_biomass_C_g_m), type = "response"))
```
...
```{r}
data.frame(summary(lsmeans(mod10, ~ tree_biomass_C_g_m), type = "response"))
```
...
```{r}
data.frame(summary(lsmeans(mod11, ~ tree_biomass_C_g_m), type = "response"))
```
...
```{r}
data.frame(summary(lsmeans(mod12, ~ tree_biomass_C_g_m), type = "response"))
```
