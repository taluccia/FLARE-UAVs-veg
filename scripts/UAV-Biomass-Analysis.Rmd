...
fig2 = cowplot::plot_grid(plot1, plot2, plot3, plot4, plot5, plot6, plot7, plot8, plot9, plot10, plot11, plot12, labels = "AUTO", align = "hv", label_size = 12, ncol= 3) + 
  ...
  draw_label("*", x = .30, y = .34, size = 36, fontface = "bold") +
  draw_label("*", x = .30, y = .09, size = 36, fontface = "bold") +
...
```{r eval=FALSE, include=FALSE}
ggsave("../figures/2020-06-07_Biomass-live-woody-ndvi-gcc_sig.jpeg", plot = fig2, width = 6, height = 7, units = c("in"), dpi=600 )
```
