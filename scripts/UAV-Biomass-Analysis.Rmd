...
```{r}
fit1 = lm(mean_gcc_25cm ~ live_woody_biomass_C_g_m, data = field_gcc)
```
...
```{r}
fit2 = lm(mean_gcc_50cm ~ live_woody_biomass_C_g_m, data = field_gcc)
```
...
```{r}
fit3 = lm(mean_gcc_1m ~ live_woody_biomass_C_g_m, data = field_gcc)
```
...
```{r}
fit4 = lm(mean_gcc_3m ~ live_woody_biomass_C_g_m, data = field_gcc)
```
...
```{r}
fit5 = lm(mean_gcc_5m ~ live_woody_biomass_C_g_m, data = field_gcc)
```
...
```{r}
fit6 = lm(mean_gcc_10m ~ live_woody_biomass_C_g_m, data = field_gcc)
```
...
```{r}
fit7 = lm(mean_ndvi_25cm ~ live_woody_biomass_C_g_m, data = field_gcc_ndvi)
```
...
```{r}
fit8 = lm(mean_ndvi_50cm ~ live_woody_biomass_C_g_m, data = field_gcc_ndvi)
```
...
```{r}
fit9 = lm(mean_ndvi_1m ~ live_woody_biomass_C_g_m, data = field_gcc_ndvi)
```
...
```{r}
fit10 = lm(mean_ndvi_3m ~ live_woody_biomass_C_g_m, data = field_gcc_ndvi)
```
...
```{r}
fit11 = lm(mean_ndvi_5m ~ live_woody_biomass_C_g_m, data = field_gcc_ndvi)
```
...
```{r}
fit12 = lm(mean_ndvi_10m ~ live_woody_biomass_C_g_m, data = field_gcc_ndvi)
```
