...
write.csv(model_sum11, '../outputs/model_summary/2020-05-27_all-woody-biomass-gcc-ndvi.csv', row.names = F)
```
...
### Save to  csv
```{r eval=FALSE, include=FALSE}
write.csv(gcc_ndvi_data, '../outputs/model_summary/2020-06-02_all-woody-biomass-gcc-ndvi-dAIC.csv', row.names = F)
```
...
```{r eval=FALSE, include=FALSE}
ggsave("../figures/2020-05-29_Biomass-all-woody-ndvi-gcc.jpeg", plot = fig1, width = 6, height = 7, units = c("in"), dpi=600 )
```
...
fig2 = cowplot::plot_grid(plot1, plot2, plot3, plot4, plot5, plot6, plot7, plot8, plot9, plot10, plot11, plot12, labels = "AUTO", align = "hv", label_size = 12, ncol= 3) + 
  theme(plot.margin = margin(0, 0, 0, 0)) +
  draw_label("*", x = .30, y = .59, size = 36, fontface = "bold") +
  draw_label("*", x = .30, y = .84, size = 36, fontface = "bold") +
  draw_label("*", x = .63, y = .59, size = 36, fontface = "bold") +
  draw_label("*", x = .63, y = .84, size = 36, fontface = "bold") +
  draw_label("*", x = .96, y = .59, size = 36, fontface = "bold") +
  draw_label("*", x = .96, y = .84, size = 36, fontface = "bold") 
...
```{r eval=FALSE, include=FALSE}
ggsave("../figures/2020-05-29_Biomass-all-woody-ndvi-gcc_sig.jpeg", plot = fig2, width = 6, height = 7, units = c("in"), dpi=600 )
```
