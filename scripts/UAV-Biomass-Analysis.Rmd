...
```{r}
mod1 = glm(mean_gcc_25cm ~ woody_biomass_C_g_m, data = field_gcc, family = gaussian)
```
...
```{r}
data.frame(summary(lsmeans(mod1, ~ woody_biomass_C_g_m), type = "response"))
```

#### Data for graph

```{r}
preddat_mod1 = data.frame(woody_biomass_C_g_m = field_gcc$woody_biomass_C_g_m)
...
##### No labels
```{r}
plot_mod1 = ggplot(data = field_gcc1, aes(x = woody_biomass_C_g_m, y = mean_gcc_25cm)) + 
    geom_point(size = 2) +  
...
##### labels
```{r}
plot1 = ggplot(data = field_gcc1, aes(x = woody_biomass_C_g_m, y = mean_gcc_25cm)) + 
    geom_point(size = 2) +  
    geom_line(aes(y = pred_mod1), linetype = 1, size = 2) + 
    geom_ribbon( aes(ymin = lcl_mod1, ymax = ucl_mod1, color = NULL, show.legend = FALSE), alpha = .15) +
    geom_line(aes(y= lcl_mod1), linetype = 'longdash', size = 1) + 
  ...
  labs(x=expression(AGWB~(g~C~m^-2))) +
    reg_theme +
...
```{r}
mod2 = glm(mean_gcc_50cm ~ woody_biomass_C_g_m, data = field_gcc, family = gaussian)
```
...
```{r}
data.frame(summary(lsmeans(mod2, ~ woody_biomass_C_g_m), type = "response"))
```

#### Data for graph
```{r}
preddat_mod2 = data.frame(woody_biomass_C_g_m = field_gcc$woody_biomass_C_g_m)
...
##### no labels
```{r}
plot_mod2 = ggplot(data = field_gcc2, aes(x = woody_biomass_C_g_m, y = mean_gcc_50cm)) + 
    geom_point(size = 2) +  
...
##### Labels
```{r}
plot2 = ggplot(data = field_gcc2, aes(x = woody_biomass_C_g_m, y = mean_gcc_50cm)) + 
    geom_point(size = 2) +  
    geom_line(aes(y = pred_mod2), linetype = 1, size = 2) + 
    geom_ribbon( aes(ymin = lcl_mod2, ymax = ucl_mod2, color = NULL, show.legend = FALSE), alpha = .15) +
    geom_line(aes(y= lcl_mod2), linetype = 'longdash', size = 1) + 
...
```{r}
fig2 = ggplot(data = field_gcc2, aes(x = woody_biomass_C_g_m, y = mean_gcc_50cm)) + 
    geom_point(size = 2) +  
    geom_line(aes(y = pred_mod2), linetype = 1, size = 2) + 
    geom_ribbon( aes(ymin = lcl_mod2, ymax = ucl_mod2, color = NULL, show.legend = FALSE), alpha = .15) +
    geom_line(aes(y= lcl_mod2), linetype = 'longdash', size = 1) + 
...
```{r}
mod3 = glm(mean_gcc_1m ~ woody_biomass_C_g_m, data = field_gcc, family = gaussian)
```
...
```{r}
data.frame(summary(lsmeans(mod3, ~ woody_biomass_C_g_m), type = "response"))
```

#### Data for graph
```{r}
preddat_mod3 = data.frame(woody_biomass_C_g_m = field_gcc$woody_biomass_C_g_m)
...
##### No labels
```{r}
plot_mod3 = ggplot(data = field_gcc3, aes(x = woody_biomass_C_g_m, y = mean_gcc_1m)) + 
    geom_point(size = 2) +  
...
##### labels
```{r}
plot3 = ggplot(data = field_gcc3, aes(x = woody_biomass_C_g_m, y = mean_gcc_1m)) + 
    geom_point(size = 2) +  
    geom_line(aes(y = pred_mod3), linetype = 1, size = 2) + 
    geom_ribbon( aes(ymin = lcl_mod3, ymax = ucl_mod3, color = NULL, show.legend = FALSE), alpha = .15) +
    geom_line(aes(y= lcl_mod3), linetype = 'longdash', size = 1) + 
    geom_line(aes(y=ucl_mod3), linetype='longdash', size = 1) +
   reg_theme +  labs(x=expression(AGWB~(g~C~m^-2))) +
...
```{r}
mod4 = glm(mean_gcc_3m ~ woody_biomass_C_g_m, data = field_gcc, family = gaussian)
```
...
```{r}
data.frame(summary(lsmeans(mod4, ~ woody_biomass_C_g_m), type = "response"))
```

#### Data for graph
```{r}
preddat_mod4 = data.frame(woody_biomass_C_g_m = field_gcc$woody_biomass_C_g_m)
...
##### No labels
```{r}
plot_mod4 = ggplot(data = field_gcc4, aes(x = woody_biomass_C_g_m, y = mean_gcc_3m)) + 
    geom_point(size = 2) +  
...
##### labels
```{r}
plot4 = ggplot(data = field_gcc4, aes(x = woody_biomass_C_g_m, y = mean_gcc_3m)) + 
    geom_point(size = 2) +  
    geom_line(aes(y = pred_mod4), linetype = 1, size = 2) + 
    geom_ribbon( aes(ymin = lcl_mod4, ymax = ucl_mod4, color = NULL, show.legend = FALSE), alpha = .15) +
    geom_line(aes(y= lcl_mod4), linetype = 'longdash', size = 1) + 
...
```{r}
mod5 = glm(mean_gcc_5m ~ woody_biomass_C_g_m, data = field_gcc, family = gaussian)
```
...
```{r}
data.frame(summary(lsmeans(mod5, ~ woody_biomass_C_g_m), type = "response"))
```

#### Data for graph
```{r}
preddat_mod5 = data.frame(woody_biomass_C_g_m = field_gcc$woody_biomass_C_g_m)
...
##### No labels
```{r}
plot_mod5 = ggplot(data = field_gcc5, aes(x =woody_biomass_C_g_m, y = mean_gcc_5m)) + 
    geom_point(size = 2) +  
...
##### labels
```{r}
plot5 = ggplot(data = field_gcc5, aes(x =woody_biomass_C_g_m, y = mean_gcc_5m)) + 
    geom_point(size = 2) +  
    geom_line(aes(y = pred_mod5), linetype = 1, size = 2) + 
    geom_ribbon( aes(ymin = lcl_mod5, ymax = ucl_mod5, color = NULL, show.legend = FALSE), alpha = .15) +
    geom_line(aes(y= lcl_mod5), linetype = 'longdash', size = 1) + 
...
```{r}
mod6 = glm(mean_gcc_10m ~ woody_biomass_C_g_m, data = field_gcc, family = gaussian)
```
...
```{r}
data.frame(summary(lsmeans(mod6, ~ woody_biomass_C_g_m), type = "response"))
```

#### Data for graph

```{r}
preddat_mod6 = data.frame(woody_biomass_C_g_m = field_gcc$woody_biomass_C_g_m)
...
##### No labels
```{r}
plot_mod6 = ggplot(data = field_gcc6, aes(x = woody_biomass_C_g_m, y = mean_gcc_10m)) + 
    geom_point(size = 2) +  
...
##### labels
```{r}
plot6 = ggplot(data = field_gcc6, aes(x = woody_biomass_C_g_m, y = mean_gcc_10m)) + 
    geom_point(size = 2) +  
    geom_line(aes(y = pred_mod6), linetype = 1, size = 2) + 
    geom_ribbon( aes(ymin = lcl_mod6, ymax = ucl_mod6, color = NULL, show.legend = FALSE), alpha = .15) +
    geom_line(aes(y= lcl_mod6), linetype = 'longdash', size = 1) + 
...
```{r}
mod7 = glm(mean_ndvi_25cm ~ woody_biomass_C_g_m, data = field_gcc_ndvi, family = gaussian)
```
...
```{r}
data.frame(summary(lsmeans(mod7, ~ woody_biomass_C_g_m), type = "response"))
```

#### Data for graph
```{r}
preddat_mod7 = data.frame(woody_biomass_C_g_m = field_gcc_ndvi$woody_biomass_C_g_m)
...
##### No labels
```{r}
plot_mod7 = ggplot(data = field_gcc_ndvi7, aes(x = woody_biomass_C_g_m, y = mean_ndvi_25cm)) + 
    geom_point(size = 2) +  
...
##### labels
```{r}
plot7 = ggplot(data = field_gcc_ndvi7, aes(x = woody_biomass_C_g_m, y = mean_ndvi_25cm)) + 
    geom_point(size = 2) +  
    geom_line(aes(y = pred_mod7), linetype = 1, size = 2) + 
    geom_ribbon( aes(ymin = lcl_mod7, ymax = ucl_mod7, color = NULL, show.legend = FALSE), alpha = .15) +
    geom_line(aes(y= lcl_mod7), linetype = 'longdash', size = 1) + 
...
```{r}
mod8 = glm(mean_ndvi_50cm ~ woody_biomass_C_g_m, data = field_gcc_ndvi, family = gaussian)
```
...
```{r}
data.frame(summary(lsmeans(mod8, ~ woody_biomass_C_g_m), type = "response"))
```

#### Data for graph
```{r}
preddat_mod8 = data.frame(woody_biomass_C_g_m = field_gcc_ndvi$woody_biomass_C_g_m)
...
##### No labels
```{r}
plot_mod8 = ggplot(data = field_gcc_ndvi8, aes(x = woody_biomass_C_g_m, y = mean_ndvi_50cm)) + 
    geom_point(size = 2) +  
...
##### labels
```{r}
plot8 = ggplot(data = field_gcc_ndvi8, aes(x = woody_biomass_C_g_m, y = mean_ndvi_50cm)) + 
    geom_point(size = 2) +  
    geom_line(aes(y = pred_mod8), linetype = 1, size = 2) + 
    geom_ribbon( aes(ymin = lcl_mod8, ymax = ucl_mod8, color = NULL, show.legend = FALSE), alpha = .15) +
    geom_line(aes(y= lcl_mod8), linetype = 'longdash', size = 1) + 
...
```{r}
mod9 = glm(mean_ndvi_1m ~ woody_biomass_C_g_m, data = field_gcc_ndvi, family = gaussian)
```
...
```{r}
data.frame(summary(lsmeans(mod9, ~ woody_biomass_C_g_m), type = "response"))
```

#### Data for graph
```{r}
preddat_mod9 = data.frame(woody_biomass_C_g_m = field_gcc_ndvi$woody_biomass_C_g_m)
...
##### No labels
```{r}
plot_mod9 = ggplot(data = field_gcc_ndvi9, aes(x = woody_biomass_C_g_m, y = mean_ndvi_1m)) + 
    geom_point(size = 2) +  
...
##### labels
```{r}
plot9 = ggplot(data = field_gcc_ndvi9, aes(x = woody_biomass_C_g_m, y = mean_ndvi_1m)) + 
    geom_point(size = 2) +  
    geom_line(aes(y = pred_mod9), linetype = 1, size = 2) + 
    geom_ribbon( aes(ymin = lcl_mod9, ymax = ucl_mod9, color = NULL, show.legend = FALSE), alpha = .15) +
    geom_line(aes(y= lcl_mod9), linetype = 'longdash', size = 1) + 
...
```{r}
mod10 = glm(mean_ndvi_3m ~ woody_biomass_C_g_m, data = field_gcc_ndvi, family = gaussian)
```
...
```{r}
data.frame(summary(lsmeans(mod10, ~ woody_biomass_C_g_m), type = "response"))
```

#### Data for graph
```{r}
preddat_mod10 = data.frame(woody_biomass_C_g_m = field_gcc_ndvi$woody_biomass_C_g_m)
...
##### No labels
```{r}
plot_mod10 = ggplot(data = field_gcc_ndvi10, aes(x = woody_biomass_C_g_m, y = mean_ndvi_3m)) + 
    geom_point(size = 2) +  
...
##### labels
```{r}
plot10 = ggplot(data = field_gcc_ndvi10, aes(x = woody_biomass_C_g_m, y = mean_ndvi_3m)) + 
    geom_point(size = 2) +  
    geom_line(aes(y = pred_mod10), linetype = 1, size = 2) + 
    geom_ribbon( aes(ymin = lcl_mod10, ymax = ucl_mod10, color = NULL, show.legend = FALSE), alpha = .15) +
    geom_line(aes(y= lcl_mod10), linetype = 'longdash', size = 1) + 
...
```{r}
mod11 = glm(mean_ndvi_5m ~ woody_biomass_C_g_m, data = field_gcc_ndvi, family = gaussian)
```
...
```{r}
data.frame(summary(lsmeans(mod11, ~ woody_biomass_C_g_m), type = "response"))
```

#### Data for graph
```{r}
preddat_mod11 = data.frame(woody_biomass_C_g_m = field_gcc_ndvi$woody_biomass_C_g_m)
...
##### No labels
```{r}
plot_mod11 = ggplot(data = field_gcc_ndvi11, aes(x = woody_biomass_C_g_m, y = mean_ndvi_5m)) + 
    geom_point(size = 2) +  
...
##### labels
```{r}
plot11 = ggplot(data = field_gcc_ndvi11, aes(x = woody_biomass_C_g_m, y = mean_ndvi_5m)) + 
    geom_point(size = 2) +  
    geom_line(aes(y = pred_mod11), linetype = 1, size = 2) + 
    geom_ribbon( aes(ymin = lcl_mod11, ymax = ucl_mod11, color = NULL, show.legend = FALSE), alpha = .15) +
    geom_line(aes(y= lcl_mod11), linetype = 'longdash', size = 1) + 
...
```{r}
mod12 = glm(mean_ndvi_10m ~ woody_biomass_C_g_m, data = field_gcc_ndvi, family = gaussian)
```
...
```{r}
data.frame(summary(lsmeans(mod12, ~ woody_biomass_C_g_m), type = "response"))
```

#### Data for graph
```{r}
preddat_mod12 = data.frame(woody_biomass_C_g_m = field_gcc_ndvi$woody_biomass_C_g_m)
...
##### No labels
```{r}
plot_mod12 = ggplot(data = field_gcc_ndvi12, aes(x = woody_biomass_C_g_m, y = mean_ndvi_10m)) + 
    geom_point(size = 2) +  
...
##### labels
```{r}
plot12 = ggplot(data = field_gcc_ndvi12, aes(x = woody_biomass_C_g_m, y = mean_ndvi_10m)) + 
    geom_point(size = 2) +  
    geom_line(aes(y = pred_mod12), linetype = 1, size = 2) + 
    geom_ribbon( aes(ymin = lcl_mod12, ymax = ucl_mod12, color = NULL, show.legend = FALSE), alpha = .15) +
    geom_line(aes(y= lcl_mod12), linetype = 'longdash', size = 1) + 
...
```{r eval=FALSE, include=FALSE}
ggsave("../figures/2020-05-21_Biomass-all-woody-ndvi-gcc.jpeg", plot = fig1, width = 6, height = 7, units = c("in"), dpi=600 )
```
