...
```{r}
plot1 = ggplot(data = field_gcc1, aes(x = woody_biomass_g_m, y = mean_gcc_25cm)) + 
    geom_point(size = 2) +  
    geom_line(aes(y = pred_mod1), linetype = 1, size = 2) + 
    geom_ribbon( aes(ymin = lcl_mod1, ymax = ucl_mod1, color = NULL, show.legend = FALSE), alpha = .15) +
    geom_line(aes(y= lcl_mod1), linetype = 'longdash', size = 1) + 
    ...
    reg_theme +
  scale_y_continuous(breaks = seq(0.3, 0.45, by = .05), labels = c("0.3", "", "0.4", ""))
...
```{r}
plot2 = ggplot(data = field_gcc2, aes(x = woody_biomass_g_m, y = mean_gcc_50cm)) + 
    geom_point(size = 2) +  
    geom_line(aes(y = pred_mod2), linetype = 1, size = 2) + 
    geom_ribbon( aes(ymin = lcl_mod2, ymax = ucl_mod2, color = NULL, show.legend = FALSE), alpha = .15) +
    geom_line(aes(y= lcl_mod2), linetype = 'longdash', size = 1) + 
...
```{r}
plot3 = ggplot(data = field_gcc3, aes(x = woody_biomass_g_m, y = mean_gcc_1m)) + 
    geom_point(size = 2) +  
    geom_line(aes(y = pred_mod3), linetype = 1, size = 2) + 
    geom_ribbon( aes(ymin = lcl_mod3, ymax = ucl_mod3, color = NULL, show.legend = FALSE), alpha = .15) +
    geom_line(aes(y= lcl_mod3), linetype = 'longdash', size = 1) + 
...
```
```{r}
plot4 = ggplot(data = field_gcc4, aes(x = woody_biomass_g_m, y = mean_gcc_3m)) + 
    geom_point(size = 2) +  
    geom_line(aes(y = pred_mod4), linetype = 1, size = 2) + 
    geom_ribbon( aes(ymin = lcl_mod4, ymax = ucl_mod4, color = NULL, show.legend = FALSE), alpha = .15) +
    geom_line(aes(y= lcl_mod4), linetype = 'longdash', size = 1) + 
  ...
  scale_y_continuous(breaks = seq(0.3, 0.45, by = .05), labels = c("0.3", "0.35", "0.4", "0.45"))
...
```{r}
plot5 = ggplot(data = field_gcc5, aes(x =woody_biomass_g_m, y = mean_gcc_5m)) + 
    geom_point(size = 2) +  
    geom_line(aes(y = pred_mod5), linetype = 1, size = 2) + 
    geom_ribbon( aes(ymin = lcl_mod5, ymax = ucl_mod5, color = NULL, show.legend = FALSE), alpha = .15) +
    geom_line(aes(y= lcl_mod5), linetype = 'longdash', size = 1) + 
...
```{r}
plot6 = ggplot(data = field_gcc6, aes(x = woody_biomass_g_m, y = mean_gcc_10m)) + 
    geom_point(size = 2) +  
    geom_line(aes(y = pred_mod6), linetype = 1, size = 2) + 
    geom_ribbon( aes(ymin = lcl_mod6, ymax = ucl_mod6, color = NULL, show.legend = FALSE), alpha = .15) +
    geom_line(aes(y= lcl_mod6), linetype = 'longdash', size = 1) + 
  ...
  scale_y_continuous(breaks = seq(0.3, 0.45, by = .05), labels = c("0.3", "", "0.4", ""), expand = c(0,0))
...
```{r}
mod7 = glm(mean_ndvi_25cm ~ woody_biomass_g_m, data = field_gcc_ndvi, family = gaussian)
```
...
```{r}
data.frame(summary(lsmeans(mod7, ~ woody_biomass_g_m), type = "response"))
```

#### Data for graph
```{r}
preddat_mod7 = data.frame(woody_biomass_g_m = field_gcc_ndvi$woody_biomass_g_m)
...
```{r}
plot_mod7 = ggplot(data = field_gcc_ndvi7, aes(x = woody_biomass_g_m, y = mean_ndvi_25cm)) + 
    geom_point(size = 2) +  
...
```{r}
plot7 = ggplot(data = field_gcc_ndvi7, aes(x = woody_biomass_g_m, y = mean_ndvi_25cm)) + 
    geom_point(size = 2) +  
    geom_line(aes(y = pred_mod7), linetype = 1, size = 2) + 
    geom_ribbon( aes(ymin = lcl_mod7, ymax = ucl_mod7, color = NULL, show.legend = FALSE), alpha = .15) +
    geom_line(aes(y= lcl_mod7), linetype = 'longdash', size = 1) + 
    ...
    reg_theme +  
  guides(color=guide_legend(override.aes=list(fill=NA))) +
  scale_y_continuous(breaks = seq(0.4, 0.8, by = .1))
plot7
```

### 8. Model: NDVI Biomass 50cm
```{r}
mod8 = glm(mean_ndvi_50cm ~ woody_biomass_g_m, data = field_gcc_ndvi, family = gaussian)
```
...
```{r}
data.frame(summary(lsmeans(mod8, ~ woody_biomass_g_m), type = "response"))
```

#### Data for graph
```{r}
preddat_mod8 = data.frame(woody_biomass_g_m = field_gcc_ndvi$woody_biomass_g_m)
...
```{r}
plot_mod8 = ggplot(data = field_gcc_ndvi8, aes(x = woody_biomass_g_m, y = mean_ndvi_50cm)) + 
    geom_point(size = 2) +  
...
```{r}
plot8 = ggplot(data = field_gcc_ndvi8, aes(x = woody_biomass_g_m, y = mean_ndvi_50cm)) + 
    geom_point(size = 2) +  
    geom_line(aes(y = pred_mod8), linetype = 1, size = 2) + 
    geom_ribbon( aes(ymin = lcl_mod8, ymax = ucl_mod8, color = NULL, show.legend = FALSE), alpha = .15) +
    geom_line(aes(y= lcl_mod8), linetype = 'longdash', size = 1) + 
...
```{r}
mod9 = glm(mean_ndvi_1m ~ woody_biomass_g_m, data = field_gcc_ndvi, family = gaussian)
```
...
```{r}
data.frame(summary(lsmeans(mod9, ~ woody_biomass_g_m), type = "response"))
```

#### Data for graph
```{r}
preddat_mod9 = data.frame(woody_biomass_g_m = field_gcc_ndvi$woody_biomass_g_m)
...
```{r}
plot_mod9 = ggplot(data = field_gcc_ndvi9, aes(x = woody_biomass_g_m, y = mean_ndvi_1m)) + 
    geom_point(size = 2) +  
...
```{r}
plot9 = ggplot(data = field_gcc_ndvi9, aes(x = woody_biomass_g_m, y = mean_ndvi_1m)) + 
    geom_point(size = 2) +  
    geom_line(aes(y = pred_mod9), linetype = 1, size = 2) + 
    geom_ribbon( aes(ymin = lcl_mod9, ymax = ucl_mod9, color = NULL, show.legend = FALSE), alpha = .15) +
    geom_line(aes(y= lcl_mod9), linetype = 'longdash', size = 1) + 
...
```{r}
mod10 = glm(mean_ndvi_3m ~ woody_biomass_g_m, data = field_gcc_ndvi, family = gaussian)
```
...
```{r}
data.frame(summary(lsmeans(mod10, ~ woody_biomass_g_m), type = "response"))
```

#### Data for graph
```{r}
preddat_mod10 = data.frame(woody_biomass_g_m = field_gcc_ndvi$woody_biomass_g_m)
...
```{r}
plot_mod10 = ggplot(data = field_gcc_ndvi10, aes(x = woody_biomass_g_m, y = mean_ndvi_3m)) + 
    geom_point(size = 2) +  
...
```{r}
plot10 = ggplot(data = field_gcc_ndvi10, aes(x = woody_biomass_g_m, y = mean_ndvi_3m)) + 
    geom_point(size = 2) +  
    geom_line(aes(y = pred_mod10), linetype = 1, size = 2) + 
    geom_ribbon( aes(ymin = lcl_mod10, ymax = ucl_mod10, color = NULL, show.legend = FALSE), alpha = .15) +
    geom_line(aes(y= lcl_mod10), linetype = 'longdash', size = 1) + 
...
```{r}
mod11 = glm(mean_ndvi_5m ~ woody_biomass_g_m, data = field_gcc_ndvi, family = gaussian)
```
...
```{r}
data.frame(summary(lsmeans(mod11, ~ woody_biomass_g_m), type = "response"))
```

#### Data for graph
```{r}
preddat_mod11 = data.frame(woody_biomass_g_m = field_gcc_ndvi$woody_biomass_g_m)
...
```{r}
plot_mod11 = ggplot(data = field_gcc_ndvi11, aes(x = woody_biomass_g_m, y = mean_ndvi_5m)) + 
    geom_point(size = 2) +  
...
```{r}
plot11 = ggplot(data = field_gcc_ndvi11, aes(x = woody_biomass_g_m, y = mean_ndvi_5m)) + 
    geom_point(size = 2) +  
    geom_line(aes(y = pred_mod11), linetype = 1, size = 2) + 
    geom_ribbon( aes(ymin = lcl_mod11, ymax = ucl_mod11, color = NULL, show.legend = FALSE), alpha = .15) +
    geom_line(aes(y= lcl_mod11), linetype = 'longdash', size = 1) + 
...
```{r}
mod12 = glm(mean_ndvi_10m ~ woody_biomass_g_m, data = field_gcc_ndvi, family = gaussian)
```
...
```{r}
data.frame(summary(lsmeans(mod12, ~ woody_biomass_g_m), type = "response"))
```

#### Data for graph
```{r}
preddat_mod12 = data.frame(woody_biomass_g_m = field_gcc_ndvi$woody_biomass_g_m)
...
```{r}
plot_mod12 = ggplot(data = field_gcc_ndvi12, aes(x = woody_biomass_g_m, y = mean_ndvi_10m)) + 
    geom_point(size = 2) +  
...
```{r}
plot12 = ggplot(data = field_gcc_ndvi12, aes(x = woody_biomass_g_m, y = mean_ndvi_10m)) + 
    geom_point(size = 2) +  
    geom_line(aes(y = pred_mod12), linetype = 1, size = 2) + 
    geom_ribbon( aes(ymin = lcl_mod12, ymax = ucl_mod12, color = NULL, show.legend = FALSE), alpha = .15) +
    geom_line(aes(y= lcl_mod12), linetype = 'longdash', size = 1) + 
...
ggsave("../figures/2020-05-20_Biomass-woody-gcc.jpeg", plot = grid_biomass_gcc, width = 6, height = 7, units = c("in"), dpi=600 )
```
...
```{r eval=FALSE, include=FALSE}
ggsave("../figures/2020-05-20_Biomass-woody-ndvi.jpeg", plot = grid_biomass_ndvi, width = 6, height = 7, units = c("in"), dpi=600 )
```

## GCC and NDVI
```{r fig.height=7, fig.width=6}

grid_biomass = cowplot::plot_grid(plot_mod1, plot_mod7, plot_mod2, plot_mod8, plot_mod3, plot_mod9, plot_mod4, plot_mod10, plot_mod5, plot_mod11, plot_mod6, plot_mod12, labels = c("A", "B", "C", "D", "E", "F", "G", "H", "I", "J", "K", "L"), align = "hv", rel_heights = c(0.9, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9), ncol= 2) 
grid_biomass
...
cowplot::plot_grid(plot1, plot2, plot3, plot4, plot5, plot6, plot7, plot8, plot9, plot10, plot11, plot12, labels = c("A", "B", "C", "D", "E", "F", "G", "H", "I", "J", "K", "L"), align = "hv", rel_heights = c(0.9, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9), ncol= 3) + 
...
cowplot::plot_grid(plot_mod1, plot_mod2, plot_mod3, plot_mod4, plot_mod5, plot_mod6, plot_mod7, plot_mod8, plot_mod9, plot_mod10, plot_mod11, plot_mod12, labels = c("A", "B", "C", "D", "E", "F", "G", "H", "I", "J", "K", "L"), align = "hv", rel_heights = c(0.9, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9), ncol= 3) +
  
   draw_label("0", x = 0.057, y = 0.02, fontfamily = "sans", fontface = "plain", color = "black", size = 10) +
  draw_label("5", x = 0.145, y = 0.02, fontfamily = "sans", fontface = "plain", color = "black", size = 10) +
draw_label("10", x = 0.23, y = 0.02, fontfamily = "sans", fontface = "plain", color = "black", size = 10)+
draw_label("15", x = 0.32, y = 0.02, fontfamily = "sans", fontface = "plain", color = "black", size = 10) +
  
  draw_label("0", x = 0.39, y = 0.02, fontfamily = "sans", fontface = "plain", color = "black", size = 10) +
  draw_label("5", x = 0.48, y = 0.02, fontfamily = "sans", fontface = "plain", color = "black", size = 10) +
draw_label("10", x = 0.56, y = 0.02, fontfamily = "sans", fontface = "plain", color = "black", size = 10)+
draw_label("15", x = 0.65, y = 0.02, fontfamily = "sans", fontface = "plain", color = "black", size = 10) +
  
  draw_label("0", x = 0.725, y = 0.02, fontfamily = "sans", fontface = "plain", color = "black", size = 10) +
  draw_label("5", x = 0.81, y = 0.02, fontfamily = "sans", fontface = "plain", color = "black", size = 10) +
draw_label("10", x = 0.90, y = 0.02, fontfamily = "sans", fontface = "plain", color = "black", size = 10)+
draw_label("15", x = 0.98, y = 0.02, fontfamily = "sans", fontface = "plain", color = "black", size = 10)
...
ggdraw(xlim = c(0, 6), ylim = c(0, 7)) +
    draw_plot(plot_mod1, x = 0, y = 4.9, width = 2, height = 2) +
    draw_plot(plot_mod2, x = 2.0, y = 4.9, width =1.9, height = 2) + 
  draw_plot(plot_mod3, x = 4.0, y = 4.9, width = 2, height = 2) +
    draw_plot(plot_mod4, x = 0, y = 2.9, width = 2, height = 2) +
  
  draw_label("A", x = 0.1, y = 6.8, fontfamily = "sans", fontface = "bold", color = "black", size = 14) +
   draw_label("B", x = 2.1, y = 6.8, fontfamily = "sans", fontface = "bold", color = "black", size = 14) +
   draw_label("C", x = 4.1, y = 6.8, fontfamily = "sans", fontface = "bold", color = "black", size = 14) +
    draw_label("D", x = 0.1, y = 5.8, fontfamily = "sans", fontface = "bold", color = "black", size = 14) +
   draw_label("E", x = 2.1, y = 5.8, fontfamily = "sans", fontface = "bold", color = "black", size = 14) +
   draw_label("F", x = 4.1, y = 5.8, fontfamily = "sans", fontface = "bold", color = "black", size = 14) +
    draw_label("G", x = 0.1, y = 3.8, fontfamily = "sans", fontface = "bold", color = "black", size = 14) +
   draw_label("H", x = 2.1, y = 3.8, fontfamily = "sans", fontface = "bold", color = "black", size = 14) +
   draw_label("I", x = 4.1, y = 3.8, fontfamily = "sans", fontface = "bold", color = "black", size = 14) +
    draw_label("J", x = 0.1, y = 1.8, fontfamily = "sans", fontface = "bold", color = "black", size = 14) +
   draw_label("K", x = 2.1, y = 1.8, fontfamily = "sans", fontface = "bold", color = "black", size = 14) +
   draw_label("L", x = 4.1, y = 1.8, fontfamily = "sans", fontface = "bold", color = "black", size = 14) 
...
```{r eval=FALSE, include=FALSE}
ggsave("../figures/2020-05-20_Biomass-gcc.jpeg", plot = , width = 6, height = 7, units = c("in"), dpi=600 )
```
