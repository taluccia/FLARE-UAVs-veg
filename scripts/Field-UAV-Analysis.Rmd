...
mod13_df3 = mod13_df2 %>% 
  mutate(model = "mod13") %>% 
  mutate(response = "GCC" ) %>%  
  rename(estimate = Estimate, se = Std..Error, t_value = t.value,  p_value = Pr...t.., lcl = X2.5.., ucl = X97.5.., deviance=deviance.mod13., null_deviance= summary.mod13..null.deviance, AIC = extractAIC.mod13.) %>% select(model:response, coefficent:AIC)
mod13_df3
```
...
mod14_df3 = mod14_df2 %>% 
  mutate(model = "mod14") %>% 
  mutate(response = "GCC" ) %>%  
  rename(estimate = Estimate, se = Std..Error, t_value = t.value,  p_value = Pr...t.., lcl = X2.5.., ucl = X97.5.., deviance=deviance.mod14., null_deviance= summary.mod14..null.deviance, AIC = extractAIC.mod14.) %>% select(model:response, coefficent:AIC)
mod14_df3
```
...
mod15_df3 = mod15_df2 %>% 
  mutate(model = "mod15") %>% 
  mutate(response = "GCC" ) %>%  
  rename(estimate = Estimate, se = Std..Error, t_value = t.value,  p_value = Pr...t.., lcl = X2.5.., ucl = X97.5.., deviance=deviance.mod15., null_deviance= summary.mod15..null.deviance, AIC = extractAIC.mod15.) %>% select(model:response, coefficent:AIC)
mod15_df3
```
...
mod16_df3 = mod16_df2 %>% 
  ...
  rename(estimate = Estimate, se = Std..Error, t_value = t.value,  p_value = Pr...t.., lcl = X2.5.., ucl = X97.5.., deviance=deviance.mod16., null_deviance= summary.mod16..null.deviance, AIC = extractAIC.mod16.) %>% select(model:response, coefficent:AIC)
mod16_df3
```
...
mod17_df3 = mod17_df2 %>% 
  mutate(model = "mod17") %>% 
  mutate(response = "NDVI" ) %>%  
  rename(estimate = Estimate, se = Std..Error, t_value = t.value,  p_value = Pr...t.., lcl = X2.5.., ucl = X97.5.., deviance=deviance.mod17., null_deviance= summary.mod17..null.deviance, AIC = extractAIC.mod17.) %>% select(model:response, coefficent:AIC)
mod17_df3
```
#### Data for graph
...
mod18_df3 = mod18_df2 %>% 
  mutate(model = "mod18") %>% 
  mutate(response = "NDVI" ) %>%  
  rename(estimate = Estimate, se = Std..Error, t_value = t.value,  p_value = Pr...t.., lcl = X2.5.., ucl = X97.5.., deviance=deviance.mod18., null_deviance= summary.mod18..null.deviance, AIC = extractAIC.mod18.) %>% select(model:response, coefficent:AIC)
mod18_df3
```
