...
```{r eval=FALSE, include=FALSE}
ggsave("../figures/2020-03-02_burn-unburn.jpeg", plot = grid_plot27, width = 6, height = 4, units = c("in"), dpi=600 )
```
...
grid_plot1213 = cowplot::plot_grid(plot_mod12, plot_mod13,  labels = c("A", "B", "C"), align = "hv", ncol= 2) 
grid_plot1213
