...
( dcodds.prefire = data.frame(summary(lsmeans(prefirepyromod2, revpairwise ~ prefire|burncon),type = "response", infer = TRUE)$contrasts) )

mutate(ucl_contrast = with(mod7, fit + 2*se.fit)
