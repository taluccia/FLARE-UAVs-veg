...
ggsave("../figures/2020-05-13_Biomass-shrub-gcc.jpeg", plot = grid_biomass_gcc, width = 6, height = 7, units = c("in"), dpi=600 )
```
...
```
```{r eval=FALSE, include=FALSE}
ggsave("../figures/2020-05-13_Biomass-shrub-ndvi.jpeg", plot = grid_biomass_ndvi, width = 6, height = 7, units = c("in"), dpi=600 )
```
