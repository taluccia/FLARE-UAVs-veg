---
title: "UAV-Biomass-Shrub-Analysis"
author: "Anna Talucci"
date: "5/13/2020"
...
```{r}
mod1 = glm(mean_gcc_25cm ~ shrub_biomass_C_g_m, data = field_gcc, family = gaussian)
```
...
```{r}
data.frame(summary(lsmeans(mod1, ~ shrub_biomass_C_g_m), type = "response"))
```

### Data for graph

```{r}
preddat_mod1 = data.frame(shrub_biomass_C_g_m = field_gcc$shrub_biomass_C_g_m)
...
```{r}
plot_mod1 = ggplot(data = field_gcc1, aes(x = shrub_biomass_C_g_m, y = mean_gcc_25cm)) + 
    geom_point(size = 2) +  
    ...
    labs(x=expression(Shrub~biomass~(g~C~m^-2))) +
    reg_theme
plot_mod1
```
...
```{r}
mod2 = glm(mean_gcc_50cm ~ shrub_biomass_C_g_m, data = field_gcc, family = gaussian)
```
...
```{r}
data.frame(summary(lsmeans(mod2, ~ shrub_biomass_C_g_m), type = "response"))
```

### Data for graph
```{r}
preddat_mod2 = data.frame(shrub_biomass_C_g_m = field_gcc$shrub_biomass_C_g_m)
...
```{r}
plot_mod2 = ggplot(data = field_gcc2, aes(x = shrub_biomass_C_g_m, y = mean_gcc_50cm)) + 
    geom_point(size = 2) +  
...
```{r}
mod3 = glm(mean_gcc_1m ~ shrub_biomass_C_g_m, data = field_gcc, family = gaussian)
```
...
```{r}
data.frame(summary(lsmeans(mod3, ~ shrub_biomass_C_g_m), type = "response"))
```

### Data for graph
```{r}
preddat_mod3 = data.frame(shrub_biomass_C_g_m = field_gcc$shrub_biomass_C_g_m)
...
```{r}
plot_mod3 = ggplot(data = field_gcc3, aes(x = shrub_biomass_C_g_m, y = mean_gcc_1m)) + 
    geom_point(size = 2) +  
...
```{r}
mod4 = glm(mean_gcc_3m ~ shrub_biomass_C_g_m, data = field_gcc, family = gaussian)
```
...
```{r}
data.frame(summary(lsmeans(mod4, ~ shrub_biomass_C_g_m), type = "response"))
```

### Data for graph
```{r}
preddat_mod4 = data.frame(shrub_biomass_C_g_m = field_gcc$shrub_biomass_C_g_m)
...
```{r}
plot_mod4 = ggplot(data = field_gcc4, aes(x = shrub_biomass_C_g_m, y = mean_gcc_3m)) + 
    geom_point(size = 2) +  
...
```{r}
mod5 = glm(mean_gcc_5m ~ shrub_biomass_C_g_m, data = field_gcc, family = gaussian)
```
...
```{r}
data.frame(summary(lsmeans(mod5, ~ shrub_biomass_C_g_m), type = "response"))
```

### Data for graph
```{r}
preddat_mod5 = data.frame(shrub_biomass_C_g_m = field_gcc$shrub_biomass_C_g_m)
...
```{r}
plot_mod5 = ggplot(data = field_gcc5, aes(x =shrub_biomass_C_g_m, y = mean_gcc_5m)) + 
    geom_point(size = 2) +  
...
```{r}
mod6 = glm(mean_gcc_10m ~ shrub_biomass_C_g_m, data = field_gcc, family = gaussian)
```
...
```{r}
data.frame(summary(lsmeans(mod6, ~ shrub_biomass_C_g_m), type = "response"))
```

### Data for graph

```{r}
preddat_mod6 = data.frame(shrub_biomass_C_g_m = field_gcc$shrub_biomass_C_g_m)
...
```{r}
plot_mod6 = ggplot(data = field_gcc6, aes(x = shrub_biomass_C_g_m, y = mean_gcc_10m)) + 
    geom_point(size = 2) +  
...
## 7. Model: NDVI
```{r}
mod7 = glm(mean_ndvi_25cm ~ shrub_biomass_C_g_m, data = field_gcc_ndvi, family = gaussian)
```
...
```{r}
data.frame(summary(lsmeans(mod7, ~ shrub_biomass_C_g_m), type = "response"))
```

### Data for graph
```{r}
preddat_mod7 = data.frame(shrub_biomass_C_g_m = field_gcc_ndvi$shrub_biomass_C_g_m)
...
```{r}
plot_mod7 = ggplot(data = field_gcc_ndvi7, aes(x = shrub_biomass_C_g_m, y = mean_ndvi_25cm)) + 
    geom_point(size = 2) +  
...
```{r}
mod8 = glm(mean_ndvi_50cm ~ shrub_biomass_C_g_m, data = field_gcc_ndvi, family = gaussian)
```
...
```{r}
data.frame(summary(lsmeans(mod8, ~ shrub_biomass_C_g_m), type = "response"))
```

### Data for graph
```{r}
preddat_mod8 = data.frame(shrub_biomass_C_g_m = field_gcc_ndvi$shrub_biomass_C_g_m)
...
```{r}
plot_mod8 = ggplot(data = field_gcc_ndvi8, aes(x = shrub_biomass_C_g_m, y = mean_ndvi_50cm)) + 
    geom_point(size = 2) +  
...
```{r}
mod9 = glm(mean_ndvi_1m ~ shrub_biomass_C_g_m, data = field_gcc_ndvi, family = gaussian)
```
...
```{r}
data.frame(summary(lsmeans(mod9, ~ shrub_biomass_C_g_m), type = "response"))
```

### Data for graph
```{r}
preddat_mod9 = data.frame(shrub_biomass_C_g_m = field_gcc_ndvi$shrub_biomass_C_g_m)
...
```{r}
plot_mod9 = ggplot(data = field_gcc_ndvi9, aes(x = shrub_biomass_C_g_m, y = mean_ndvi_1m)) + 
    geom_point(size = 2) +  
...
```{r}
mod10 = glm(mean_ndvi_3m ~ shrub_biomass_C_g_m, data = field_gcc_ndvi, family = gaussian)
```
...
```{r}
data.frame(summary(lsmeans(mod10, ~ shrub_biomass_C_g_m), type = "response"))
```

### Data for graph
```{r}
preddat_mod10 = data.frame(shrub_biomass_C_g_m = field_gcc_ndvi$shrub_biomass_C_g_m)
...
```{r}
plot_mod10 = ggplot(data = field_gcc_ndvi10, aes(x = shrub_biomass_C_g_m, y = mean_ndvi_3m)) + 
    geom_point(size = 2) +  
...
```{r}
mod11 = glm(mean_ndvi_5m ~ shrub_biomass_C_g_m, data = field_gcc_ndvi, family = gaussian)
```
...
```{r}
data.frame(summary(lsmeans(mod11, ~ shrub_biomass_C_g_m), type = "response"))
```

### Data for graph
```{r}
preddat_mod11 = data.frame(shrub_biomass_C_g_m = field_gcc_ndvi$shrub_biomass_C_g_m)
...
```{r}
plot_mod11 = ggplot(data = field_gcc_ndvi11, aes(x = shrub_biomass_C_g_m, y = mean_ndvi_5m)) + 
    geom_point(size = 2) +  
...
```{r}
mod12 = glm(mean_ndvi_10m ~ shrub_biomass_C_g_m, data = field_gcc_ndvi, family = gaussian)
```
...
```{r}
data.frame(summary(lsmeans(mod12, ~ shrub_biomass_C_g_m), type = "response"))
```

### Data for graph
```{r}
preddat_mod12 = data.frame(shrub_biomass_C_g_m = field_gcc_ndvi$shrub_biomass_C_g_m)
...
```{r}
plot_mod12 = ggplot(data = field_gcc_ndvi12, aes(x = shrub_biomass_C_g_m, y = mean_ndvi_10m)) + 
    geom_point(size = 2) +  
...
ggsave("../figures/2020-05-20_Biomass-shrub-gcc.jpeg", plot = grid_biomass_gcc, width = 6, height = 7, units = c("in"), dpi=600 )
```
...
```
```{r eval=FALSE, include=FALSE}
ggsave("../figures/2020-05-20_Biomass-shrub-ndvi.jpeg", plot = grid_biomass_ndvi, width = 6, height = 7, units = c("in"), dpi=600 )
```
...
fig1 = cowplot::plot_grid(plot_mod1, plot_mod2, plot_mod3, plot_mod4, plot_mod5, plot_mod6, plot_mod7, plot_mod8, plot_mod9, plot_mod10, plot_mod11, plot_mod12, labels = "AUTO", label_size = 12, align = "hv", scale = 0.9, ncol= 3) + 
...
```{r eval=FALSE, include=FALSE}
ggsave("../figures/2020-05-21_Biomass-shrub-ndvi-gcc.jpeg", plot = fig1, width = 6, height = 7, units = c("in"), dpi=600 )
```