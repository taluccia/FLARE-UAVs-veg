...
```{r}
tree_info_uav = merge(stems,  ba,  by=c("ID","site", "transect", "plot"))
tree_info_uav
```
...
```{r}
write.csv(tree_plot,"../outputs/field_subset/tree_info_uav.csv", row.names = FALSE)
```
