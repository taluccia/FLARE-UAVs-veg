...
Write to shape file
```{r}
st_write(fd_ans_tr2_ee_10m_sf, "../outputs/field-data/fd_ans_tr2_ee_10m.shp", driver="ESRI Shapefile") 
st_write(fd_ans_tr2_ee_sf, "../outputs/field-data/fd_ans_tr2_ee_pt.shp", driver="ESRI Shapefile") 
```
...
Write to shape file
```{r}
st_write(fd_ans_tr3_ee_10m_sf, "../outputs/field-data/fd_ans_tr3_ee_10m.shp", driver="ESRI Shapefile") 
st_write(fd_ans_tr3_ee_sf, "../outputs/field-data/fd_ans_tr3_ee_pt.shp", driver="ESRI Shapefile") 
```
...
Write to shape file
```{r}
st_write(fd_alnus_tr1_ee_10m_sf, "../outputs/field-data/fd_alnus_tr1_ee_10m.shp", driver="ESRI Shapefile") 
st_write(fd_alnus_tr1_ee_sf, "../outputs/field-data/fd_alnus_tr1_ee_pt.shp", driver="ESRI Shapefile") 
```
...
Write to shape file
```{r}
st_write(fd_bp_tr1_ee_10m_sf, "../outputs/field-data/fd_bp_tr1_ee_10m.shp", driver="ESRI Shapefile") 
st_write(fd_bp_tr1_ee_sf, "../outputs/field-data/fd_bp_tr1_ee_sf.shp", driver="ESRI Shapefile") 
```
...
Write to shape file
```{r}
st_write(fd_bp_tr2_ee_10m_sf, "../outputs/field-data/fd_bp_tr2_ee_10m.shp", driver="ESRI Shapefile") 
st_write(fd_bp_tr2_ee_sf, "../outputs/field-data/fd_bp_tr2_ee_pt.shp", driver="ESRI Shapefile") 
```
...
Write to shape file
```{r}
st_write(fd_cn_tr1_ee_10m_sf, "../outputs/field-data/fd_cn_tr1_ee_10m.shp", driver="ESRI Shapefile") 
st_write(fd_cn_tr1_ee_sf, "../outputs/field-data/fd_cn_tr1_ee_pt.shp", driver="ESRI Shapefile") 
```
...
Write to shape file
```{r}
st_write(fd_cn_tr2_ee_10m_sf , "../outputs/field-data/fd_cn_tr2_ee_10m.shp", driver="ESRI Shapefile") 
st_write(fd_cn_tr2_ee_sf, "../outputs/field-data/fd_cn_tr2_ee_pt.shp", driver="ESRI Shapefile") 
```
...
Write to shape file
```{r}
st_write(fd_cn_tr3_ee_10m_sf , "../outputs/field-data/fd_cn_tr3_ee_10m.shp", driver="ESRI Shapefile") 
st_write(fd_cn_tr2_ee_sf, "../outputs/field-data/fd_cn_tr2_ee_sf.shp", driver="ESRI Shapefile") 
```