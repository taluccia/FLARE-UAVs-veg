...
cn_tr2_f17_gcc <- calc(cn_tr1_f15, f_gcc)
```

# Write GCC to file
```{r}
writeRaster(alnus_tr1_f07_gcc, filename="../output/gcc/alnus_tr1_f07_gcc", format="GTiff", overwrite=TRUE)
...
writeRaster(cn_tr2_f17_gcc, filename="../outputs/gcc/brp_tr2_f12_gcc", format="GTiff", overwrite=TRUE)
```
