...
names(extract_ans_tr2_3m) = c('ID', 'mean_gcc', 'plot_id')
extract_ans_tr2_3m
```

```{r}
extract_ans_tr3_3m$plot_id = ans_tr3_pt$ID
names(extract_ans_tr3_3m) = c('ID', 'mean_gcc', 'plot_id')
extract_ans_tr3_3m
```
...
names(extract_brp_tr1_3m) = c('ID', 'mean_gcc', 'plot_id')
extract_brp_tr1_3m
```

```{r}
extract_brp_tr2_3m$plot_id = brp_tr2_pt$ID
names(extract_brp_tr2_3m) = c('ID', 'mean_gcc', 'plot_id')
extract_brp_tr2_3m
```
...
names(extract_ans_tr2_qm) = c('ID', 'mean_gcc', 'plot_id')
extract_ans_tr2_qm
```

```{r}
extract_ans_tr3_qm$plot_id = ans_tr3_pt$ID
names(extract_ans_tr3_qm) = c('ID', 'mean_gcc', 'plot_id')
extract_ans_tr3_qm
```
...
names(extract_brp_tr1_qm) = c('ID', 'mean_gcc', 'plot_id')
extract_brp_tr1_qm
```

```{r}
extract_brp_tr2_qm$plot_id = brp_tr2_pt$ID
names(extract_brp_tr2_qm) = c('ID', 'mean_gcc', 'plot_id')
extract_brp_tr2_qm
```
...
gcc_qm = rbind(alnus_ans_qm, brp_cn_qm)
gcc_qm
```
