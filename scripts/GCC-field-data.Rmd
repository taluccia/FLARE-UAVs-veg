...
extract_ans_tr2 = raster::extract(ans_tr2_f04, ans_tr2_pt, buffer=10, fun=mean, df=TRUE )
extract_ans_tr3 = raster::extract(ans_tr3_f06, ans_tr3_pt, buffer=10, fun=mean,  df=TRUE )

extract_brp_tr1 = raster::extract(brp_tr1_f09, brp_tr1_pt, buffer=10, fun=mean, df=TRUE )

extract_brp_tr2 = raster::extract(brp_tr2_f12, brp_tr2_pt, buffer=10, fun=mean,  df=TRUE )


extract_cn_tr1 = raster::extract(cn_tr1_f15, cn_tr1_pt, buffer=10, fun=mean,  df=TRUE )
extract_cn_tr2 = raster::extract(cn_tr2_f17, cn_tr2_pt, buffer=10, fun=mean,  df=TRUE )
```
