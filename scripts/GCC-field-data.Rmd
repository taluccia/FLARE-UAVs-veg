...
gcc_1m = gcc_1m %>% select(plot_id, mean_gcc_1m) %>% rename(ID = plot_id)
gcc_1m
```
...
gcc_3m = gcc_3m %>% select(plot_id, mean_gcc_3m) %>% rename(ID = plot_id)
gcc_3m
```
...
gcc_qm = gcc_qm %>% select(plot_id, mean_gcc_25cm) %>% rename(ID = plot_id)
gcc_qm
```
